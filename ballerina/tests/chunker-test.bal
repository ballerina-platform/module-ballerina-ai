...
function testMarkdownChunkingWithHeaderStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 100, 20, PARAGRAPH);
...
function testMarkdownChunkingWithCodeBlockStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 80, 15, PARAGRAPH);
...
function testMarkdownChunkingWithHorizontalLineStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 60, 10, PARAGRAPH);
...
function testMarkdownChunkingWithParagraphStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 120, 25, PARAGRAPH);
...
function testMarkdownChunkingWithLineStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 50, 10, LINE);
...
function testMarkdownChunkingWithSentenceStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 80, 15, SENTENCE);
...
function testMarkdownChunkingWithWordStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 40, 8, WORD);
...
function testMarkdownChunkingWithCharacterStrategy() returns error? {
    ...
    Chunk[] chunks = check chunkDocumentRecursively(doc, 20, 5, CHARACTER);
...
function testMarkdownChunkingWithMixedMarkdownElements() returns error? {
    ...
    Chunk[] headerChunks = check chunkDocumentRecursively(doc, 100, 20, PARAGRAPH);
    Chunk[] codeBlockChunks = check chunkDocumentRecursively(doc, 80, 15, PARAGRAPH);
    Chunk[] paragraphChunks = check chunkDocumentRecursively(doc, 120, 25, PARAGRAPH);
